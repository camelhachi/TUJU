...
<body>
    ...
    <div class="bigcontainer">
            ...
            <div class="overlapboxmarketing">
                <div class="overlapmarketing">
                    <div class="room-selection">
                        <input type="radio" name="roomType" id="hotelRooms" onclick="changeRoom('hotelRooms')" checked>
                        <label for="hotelRooms" class="room-label">Hotel Room</label>

                        <input type="radio" name="roomType" id="multipurposeRooms" onclick="changeRoom('multipurposeRooms')">
                    ...
                    <div class="bottom">
                        ...
                        <button class="find">
                            <div class="buttext">Find Rooms</div>
                        </button>
        ...
        <div class="mac">
            <div id="aboutTuju">
                <img class="rectangleHome" src="elements/Rectangle 659.png" />
